...
<script>
  import { validator } from '../../js_sdk/validator/default-user.js';

  const db = uniCloud.database();
  const dbCollectionName = 'default-user';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("avatar,name,age,gender").get().then((res) => {
