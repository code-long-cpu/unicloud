<template>
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" :options="options" :collection="collectionList" field="avatar,name,age,gender" :where="queryWhere" :getone="true" :manual="true">
...
<script>
  ...
  import { enumConverter } from '../../js_sdk/validator/default-user.js'
